...
SOURCE_FILE="source/Series_A_Prioritization.html"
OUTPUT_FILE="index.html"
TEMPLATE_TITLE="Base10 · 1-to-10s Series A Prioritization"
INSTRUCTIONS="Enter the password to access Base10 · 1-to-10s Series A Prioritization."
